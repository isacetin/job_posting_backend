package com.isacetin.myapplication.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.isacetin.myapplication.IntegrationTest;
import com.isacetin.myapplication.repository.timezone.DateTimeWrapper;
import com.isacetin.myapplication.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM jhi_date_time_wrapper where id=%id", fieldName, id);
    }
